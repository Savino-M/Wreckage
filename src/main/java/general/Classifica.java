...
public class Classifica {
    ...
    public static void scriviClassifica(String nome, int minuti, int secondi) {
        ...
        try {
            reader = new FileReader("Java/Wreckage/res/db/db.properties");
        ...
        try {
            Connection conn = DriverManager.getConnection("jdbc:h2:./Java/Wreckage/res/db/classifica",
                    dBproperties.getProperty("user"), dBproperties.getProperty("password"));
            Statement stm = conn.createStatement();
            stm.executeUpdate("INSERT INTO classifica VALUES ('" + nome + "', INTERVAL '" + minuti + ":" + secondi
                    + "' MINUTE TO SECOND)");
