...
public class Partita {
            ...
            if (azione != null) {
                ...
                switch (azione.getTipo()) {
                    ...
                    case MOVIMENTO:
                        ...
                        if (esito == false && luogo.trim().equals("interno bunker")
                                && giocatore.getLuogoAttuale().getNomeLuogo().equals("esterno bunker")) {
                        ...
                        } else if (esito == true && luogo.trim().equals("interno bunker")
                                && giocatore.getLuogoAttuale().getNomeLuogo().equals("interno bunker")) {
                            // altrimenti si vince
                            ...
                            nome = leggi.next();
                            Classifica.scriviClassifica(nome, convertiInMinuti(tempoFinale - tempoIniziale),
                                    convertiInSecondi(tempoFinale - tempoIniziale));
                    ...
                    case VITA:
                        System.out.println(ANSI_GREEN + "\n>Attualmente hai " + giocatore.getPuntiVita()
                    ...
                    case RACCOGLI:
                        ...
                        if (!esito) {
                            System.out.println(
                                    ANSI_RED + "\n>Comando non valido. Non puoi raccogliere qualcosa che non esiste!"
                                            + ANSI_RESET);
                        } else {
    ...
    private boolean ePreposizione(String parola) {
        ...
        String[] preposizioni = { "di", "a", "da", "in", "con", "su", "per", "tra", "fra", "del", "al", "alla", "dal",
                "nella", "all'", "all' ", "nell'", "nell' ", "nel",
                "sul", "sull'", "sull' ", "della" };
